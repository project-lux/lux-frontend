...
export const itemProductionDateFacetsTransformed: Array<ITransformedData> = [
  {
    ...
    criteria: productionDateCriteria,
  },
  {
    value: '1980',
    totalItems: 19,
...
export const transformedTimelineFacets: any = {
  '1945': {
    total: 1,
    itemProductionDate: { totalItems: 1, criteria: productionDateCriteria },
  },
  '1958': {
    total: 2,
    itemProductionDate: { totalItems: 2, criteria: productionDateCriteria },
  },
  '1959': {
    total: 1,
    itemProductionDate: { totalItems: 1, criteria: productionDateCriteria },
  ...
  '1964': {
    total: 3,
    itemProductionDate: { totalItems: 3, criteria: productionDateCriteria },
  },
  '1966': {
    total: 1,
    itemProductionDate: { totalItems: 1, criteria: productionDateCriteria },
  ...
  '1971': {
    total: 13,
    itemProductionDate: { totalItems: 11, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 1, criteria: workDateCriteria },
    workPublicationDate: { totalItems: 1, criteria: workDateCriteria },
  },
  '1972': {
    total: 12,
    itemProductionDate: { totalItems: 10, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 1, criteria: workDateCriteria },
    workPublicationDate: { totalItems: 1, criteria: workDateCriteria },
  },
  '1973': {
  ...
  '1974': {
    total: 19,
    itemProductionDate: { totalItems: 17, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 2, criteria: workDateCriteria },
  },
  '1976': {
    total: 16,
    itemProductionDate: { totalItems: 12, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 2, criteria: workDateCriteria },
    workPublicationDate: { totalItems: 2, criteria: workDateCriteria },
  },
  '1977': {
    total: 20,
    itemProductionDate: { totalItems: 18, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 2, criteria: workDateCriteria },
  },
  '1978': {
    total: 2,
  ...
  '1979': {
    total: 5,
    itemProductionDate: { totalItems: 4, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 1, criteria: workDateCriteria },
  },
  '1980': {
    total: 22,
    itemProductionDate: { totalItems: 19, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 3, criteria: workDateCriteria },
  },
  '1981': {
    total: 10,
    itemProductionDate: { totalItems: 8, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 1, criteria: workDateCriteria },
    workPublicationDate: { totalItems: 1, criteria: workDateCriteria },
  },
  '1982': {
    total: 19,
    itemProductionDate: { totalItems: 15, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 2, criteria: workDateCriteria },
    workPublicationDate: { totalItems: 2, criteria: workDateCriteria },
  },
  '1983': {
    total: 27,
    itemProductionDate: { totalItems: 22, criteria: productionDateCriteria },
    workCreationDate: { totalItems: 5, criteria: workDateCriteria },
  },
  '1984': {
    total: 12,
    itemProductionDate: { totalItems: 10, criteria: productionDateCriteria },
