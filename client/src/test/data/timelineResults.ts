...
const itemProductionDate =
  'https://endpoint.yale.edu/api/facets/item?q=%7B%22producedBy%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2Fmock-person-1%22%7D%7D&name=itemProductionDate'
const workPublicationDate =
  'https://endpoint.yale.edu/api/facets/work?q=%7B%22OR%22%3A%5B%7B%22createdBy%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2Fmock-person-1%22%7D%7D%2C%7B%22publishedBy%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2Fmock-person-1%22%7D%7D%5D%7D&name=workPublicationDate'
const workCreationDate =
  'https://endpoint.yale.edu/api/facets/work?q=%7B%22OR%22%3A%5B%7B%22createdBy%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2Fmock-person-1%22%7D%7D%2C%7B%22publishedBy%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2Fmock-person-1%22%7D%7D%5D%7D&name=workCreationDate'
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export const transformedTimelineFacets: any = {
  '1945': {
    total: 1,
    [itemProductionDate]: { totalItems: 1, searchParams: '', searchTag: '' },
  },
  '1958': {
    total: 2,
    [itemProductionDate]: { totalItems: 2, searchParams: '', searchTag: '' },
  },
  '1959': {
    total: 1,
    [itemProductionDate]: { totalItems: 1, searchParams: '', searchTag: '' },
  ...
  '1964': {
    total: 3,
    [itemProductionDate]: { totalItems: 3, searchParams: '', searchTag: '' },
  },
  '1966': {
    total: 1,
    [itemProductionDate]: { totalItems: 1, searchParams: '', searchTag: '' },
  ...
  '1971': {
    total: 13,
    [itemProductionDate]: { totalItems: 11, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '', searchTag: '' },
    [workPublicationDate]: { totalItems: 1, searchParams: '', searchTag: '' },
  },
  '1972': {
    total: 12,
    [itemProductionDate]: { totalItems: 10, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '', searchTag: '' },
    [workPublicationDate]: { totalItems: 1, searchParams: '', searchTag: '' },
  },
  '1973': {
  ...
  '1974': {
    total: 19,
    [itemProductionDate]: { totalItems: 17, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '', searchTag: '' },
  },
  '1976': {
    total: 16,
    [itemProductionDate]: { totalItems: 12, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '', searchTag: '' },
    [workPublicationDate]: { totalItems: 2, searchParams: '', searchTag: '' },
  },
  '1977': {
    total: 20,
    [itemProductionDate]: { totalItems: 18, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '', searchTag: '' },
  },
  '1978': {
    total: 2,
  ...
  '1979': {
    total: 5,
    [itemProductionDate]: { totalItems: 4, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '', searchTag: '' },
  },
  '1980': {
    total: 22,
    [itemProductionDate]: { totalItems: 19, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 3, searchParams: '', searchTag: '' },
  },
  '1981': {
    total: 10,
    [itemProductionDate]: { totalItems: 8, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '', searchTag: '' },
    [workPublicationDate]: { totalItems: 1, searchParams: '', searchTag: '' },
  },
  '1982': {
    total: 19,
    [itemProductionDate]: { totalItems: 15, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '', searchTag: '' },
    [workPublicationDate]: { totalItems: 2, searchParams: '', searchTag: '' },
  },
  '1983': {
    total: 27,
    [itemProductionDate]: { totalItems: 22, searchParams: '', searchTag: '' },
    [workCreationDate]: { totalItems: 5, searchParams: '', searchTag: '' },
  },
  '1984': {
    total: 12,
    [itemProductionDate]: { totalItems: 10, searchParams: '', searchTag: '' },
