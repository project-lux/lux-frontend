...
export const transformedTimelineFacets: any = {
  '1945': {
    total: 1,
    [itemProductionDate]: { totalItems: 1, searchParams: '' },
  },
  '1958': {
    total: 2,
    [itemProductionDate]: { totalItems: 2, searchParams: '' },
  },
  '1959': {
    total: 1,
    [itemProductionDate]: { totalItems: 1, searchParams: '' },
  ...
  '1964': {
    total: 3,
    [itemProductionDate]: { totalItems: 3, searchParams: '' },
  },
  '1966': {
    total: 1,
    [itemProductionDate]: { totalItems: 1, searchParams: '' },
  ...
  '1971': {
    total: 13,
    [itemProductionDate]: { totalItems: 11, searchParams: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '' },
    [workPublicationDate]: { totalItems: 1, searchParams: '' },
  },
  '1972': {
    total: 12,
    [itemProductionDate]: { totalItems: 10, searchParams: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '' },
    [workPublicationDate]: { totalItems: 1, searchParams: '' },
  },
  '1973': {
  ...
  '1974': {
    total: 19,
    [itemProductionDate]: { totalItems: 17, searchParams: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '' },
  },
  '1976': {
    total: 16,
    [itemProductionDate]: { totalItems: 12, searchParams: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '' },
    [workPublicationDate]: { totalItems: 2, searchParams: '' },
  },
  '1977': {
    total: 20,
    [itemProductionDate]: { totalItems: 18, searchParams: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '' },
  },
  '1978': {
    total: 2,
  ...
  '1979': {
    total: 5,
    [itemProductionDate]: { totalItems: 4, searchParams: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '' },
  },
  '1980': {
    total: 22,
    [itemProductionDate]: { totalItems: 19, searchParams: '' },
    [workCreationDate]: { totalItems: 3, searchParams: '' },
  },
  '1981': {
    total: 10,
    [itemProductionDate]: { totalItems: 8, searchParams: '' },
    [workCreationDate]: { totalItems: 1, searchParams: '' },
    [workPublicationDate]: { totalItems: 1, searchParams: '' },
  },
  '1982': {
    total: 19,
    [itemProductionDate]: { totalItems: 15, searchParams: '' },
    [workCreationDate]: { totalItems: 2, searchParams: '' },
    [workPublicationDate]: { totalItems: 2, searchParams: '' },
  },
  '1983': {
    total: 27,
    [itemProductionDate]: { totalItems: 22, searchParams: '' },
    [workCreationDate]: { totalItems: 5, searchParams: '' },
  },
  '1984': {
    total: 12,
    [itemProductionDate]: { totalItems: 10, searchParams: '' },
