...
export default function personAndGroupResultsMockApi(): void {
  ...
  nock(apiUrl)
    .get(
      '/api/search/agent?q=%7B%22AND%22%3A%5B%7B%22text%22%3A%22andy%22%2C%22_lang%22%3A%22en%22%7D%2C%7B%22text%22%3A%22warhol%22%2C%22_lang%22%3A%22en%22%7D%5D%7D&page=1&pageLength=20',
    )
  ...
  for (const facet of facetNamesLists.people) {
    let sort = ''
    ...
    nock(apiUrl)
      .get(
        `/api/facets/agent?q=%7B%22AND%22%3A%5B%7B%22text%22%3A%22andy%22%2C%22_lang%22%3A%22en%22%7D%2C%7B%22text%22%3A%22warhol%22%2C%22_lang%22%3A%22en%22%7D%5D%7D&name=${facet}${sort}&page=1`,
      )
