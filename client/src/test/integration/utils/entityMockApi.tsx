...
export default function entityMockApi(): void {
  ...
  nock(apiUrl)
    .get(
      '/api/related-list/agent?name=relatedToAgent&uri=https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2F34f4eec7-7a03-49c8-b1be-976c2f6ba6ba',
    )
  ...
  nock(apiUrl)
    .get(
      '/api/search/concept?q=%7B%22influencedByAgent%22%3A%7B%22id%22%3A%22https%3A%2F%2Fendpoint.yale.edu%2Fdata%2Fperson%2F34f4eec7-7a03-49c8-b1be-976c2f6ba6ba%22%7D%7D',
    )
    .reply(200, JSON.stringify(mockResults('data/object/mock-object', 1)), {
      'Access-Control-Allow-Origin': '*',
      'Content-type': 'application/json',
  ...
  // mock the request for works created timeline
  nock(apiUrl)
    .get(
