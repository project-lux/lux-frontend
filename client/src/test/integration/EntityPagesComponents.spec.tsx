...
describe('Entity pages relationship components', () => {
  ...
  describe('Timeline', () => {
    ...
    it('renders the year search link with correct href', async () => {
      ...
      expect(link).toHaveAttribute(
        'href',
        `/view/results/objects?q={"AND":[{"producedBy":{"id":"${config.env.dataApiBaseUrl}data/person/mock-person-1"}},{"producedDate":"1983-12-31T00:00:00.000Z","_comp":"<="},{"producedDate":"1983-01-01T00:00:00.000Z","_comp":">="}]}&collapseSearch=true`,
      )
    })
  })
