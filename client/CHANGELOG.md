...
- Added AI Refinement ([#1015](https://github.com/project-lux/lux-frontend/issues/1015)).
...
- Changed 'Works Caused By' to 'Works Generated By' ([#565](https://github.com/project-lux/lux-frontend/issues/565)).
...
- Fixed overflowing icons on entity page tabs ([#792](https://github.com/project-lux/lux-frontend/issues/792)).
...
- Fixed snippet checkboxes ([#658](https://github.com/project-lux/lux-frontend/issues/658)).
...
- Added additional data-testid values that were missing for About sections ([#768](https://github.com/project-lux/lux-frontend/issues/768)).
...
- Fixed the Data Sources link uri ([#733](https://github.com/project-lux/lux-frontend/issues/733)).
...
- Fixed the collection page rendering and styling ([#655](https://github.com/project-lux/lux-frontend/issues/655)).
...
- Fixed styling and bugs on the My Collections results page ([#641](https://github.com/project-lux/lux-frontend/issues/641)).
...
- Changed the parsing and rendering of Plan Your Visit link ([#1710](https://git.yale.edu/lux-its/lux-web/issues/1710)).
...
- Removed unused React components ([#1815](https://git.yale.edu/lux-its/lux-web/issues/1815)).
...
- Added unit tests for the mapHelper ([#1835](https://git.yale.edu/lux-its/lux-web/issues/1835)).
...
- Fixed date facet comparators ([1202](https://git.yale.edu/lux-its/lux-web/issues/1202)).
...
- Changed advanced search addition of groups ([1038](https://git.yale.edu/lux-its/lux-web/issues/1038)).
...
- Added advanced search submit functionality ([1023](https://git.yale.edu/lux-its/lux-web/issues/1023)).
...
- Changed the advanced search form to render a list instead of rows ([963](https://git.yale.edu/lux-its/lux-web/issues/963)).
...
- Added related subjects component to person page ([145](https://git.yale.edu/lux-its/lux-web/issues/145)).
...
- Added physical objects page ([217](https://git.yale.edu/lux-its/lux-web/issues/217)).
- Added text value components physical objects page ([218](https://git.yale.edu/lux-its/lux-web/issues/218)).
- Added record link components physical objects page ([219](https://git.yale.edu/lux-its/lux-web/issues/219)).
- Added Where at Yale panel to physical objects page ([221](https://git.yale.edu/lux-its/lux-web/issues/221)).
- Added notes/statements to physical objects page ([220](https://git.yale.edu/lux-its/lux-web/issues/220)).
- Added header to physical objects page ([229](https://git.yale.edu/lux-its/lux-web/issues/229)).
- Added external links to physical objects page ([228](https://git.yale.edu/lux-its/lux-web/issues/228)).
- Added link menu to physical objects page ([232](https://git.yale.edu/lux-its/lux-web/issues/232)).
- Added getName function ([253](https://git.yale.edu/lux-its/lux-web/issues/253)).
- Added objects results snippet ([238](https://git.yale.edu/lux-its/lux-web/issues/238)).
- Added digital objects page ([248](https://git.yale.edu/lux-its/lux-web/issues/248)).
- Added types to search endpoints for result tabs ([274](https://git.yale.edu/lux-its/lux-web/issues/274)).
- Added linguistic objects page ([249](https://git.yale.edu/lux-its/lux-web/issues/249)).
- Added linguistic objects about section ([276](https://git.yale.edu/lux-its/lux-web/issues/276)).
- Added linguistic objects side panel ([283](https://git.yale.edu/lux-its/lux-web/issues/283)).
- Added linguistic objects results ([246](https://git.yale.edu/lux-its/lux-web/issues/246)).
- Added archive set page ([250](https://git.yale.edu/lux-its/lux-web/issues/250)).
- Added archive set results ([247](https://git.yale.edu/lux-its/lux-web/issues/247)).
- Added ObjectParser ([298](https://git.yale.edu/lux-its/lux-web/issues/298)).
- Added PersonParser ([297](https://git.yale.edu/lux-its/lux-web/issues/297)).
- Added site link to object page ([308](https://git.yale.edu/lux-its/lux-web/issues/308)).
- Added WorkParser ([302](https://git.yale.edu/lux-its/lux-web/issues/302)).
- Added EventParser ([301](https://git.yale.edu/lux-its/lux-web/issues/301)).
- Added type to the event results snippet ([321](https://git.yale.edu/lux-its/lux-web/issues/321)).
- Added ConceptParser ([300](https://git.yale.edu/lux-its/lux-web/issues/300)).
- Added support for visual item pages ([323](https://git.yale.edu/lux-its/lux-web/issues/323)).
- Added type to person result snippet ([333](https://git.yale.edu/lux-its/lux-web/issues/333)).
- Added Bugherd snippet ([324](https://git.yale.edu/lux-its/lux-web/issues/324)).
- Added pagination to the results tabs ([341](https://git.yale.edu/lux-its/lux-web/issues/341)).
- Added dimensions parser function ([193](https://git.yale.edu/lux-its/lux-web/issues/193)).
- Added identifiers to event page ([358](https://git.yale.edu/lux-its/lux-web/issues/358)).
- Added HTML parser for notes ([367](https://git.yale.edu/lux-its/lux-web/issues/367)).
- Added contributing records to place page ([420](https://git.yale.edu/lux-its/lux-web/issues/420)).
- Added original work agent for objects ([391](https://git.yale.edu/lux-its/lux-web/issues/391)).
- Added warning regarding limited functionality to landing page ([456](https://git.yale.edu/lux-its/lux-web/issues/456)).
- Added creation event to digital object page ([374](https://git.yale.edu/lux-its/lux-web/issues/374)).
- Added identifiers to works pages ([364](https://git.yale.edu/lux-its/lux-web/issues/364)).
- Added used_for event on visual works page ([463](https://git.yale.edu/lux-its/lux-web/issues/463)).
- Added subject_to on works page ([475](https://git.yale.edu/lux-its/lux-web/issues/475)).
- Added objects created tab to person page ([485](https://git.yale.edu/lux-its/lux-web/issues/485)).
- Added action menu to the concept page ([506](https://git.yale.edu/lux-its/lux-web/issues/506)).
- Added styling to the results snippets ([505](https://git.yale.edu/lux-its/lux-web/issues/505)).
- Added collections page ([464](https://git.yale.edu/lux-its/lux-web/issues/464)).
- Added actions menu to all entity pages ([540](https://git.yale.edu/lux-its/lux-web/issues/540)).
- Added facet container ([512](https://git.yale.edu/lux-its/lux-web/issues/512)).
- Added facet selected widget ([515](https://git.yale.edu/lux-its/lux-web/issues/515)).
- Added facet selection row ([514](https://git.yale.edu/lux-its/lux-web/issues/514)).
- Added facet accordion for sections ([113](https://git.yale.edu/lux-its/lux-web/issues/113)).
- Added facet checklist ([114](https://git.yale.edu/lux-its/lux-web/issues/114)).
- Added facet requests for checklist item ([539](https://git.yale.edu/lux-its/lux-web/issues/539)).
- Added facet checklist submission ([551](https://git.yale.edu/lux-its/lux-web/issues/551)).
- Added facet selection functionality ([515](https://git.yale.edu/lux-its/lux-web/issues/515)).
- Added GA-4 analytics code ([37](https://git.yale.edu/lux-its/lux-web/issues/37)).
- Added search bar to results page ([563](https://git.yale.edu/lux-its/lux-web/issues/563)).
- Added facet date input ([513](https://git.yale.edu/lux-its/lux-web/issues/513)).
- Added page number to the url for naviation purposes ([568](https://git.yale.edu/lux-its/lux-web/issues/568)).
- Added works created by tab to people page ([446](https://git.yale.edu/lux-its/lux-web/issues/446)).
- Added related agents data ([442](https://git.yale.edu/lux-its/lux-web/issues/442)).
- Added temporary work facets ([591](https://git.yale.edu/lux-its/lux-web/issues/591)).
- Added Currency type for concepts and groupings ([599](https://git.yale.edu/lux-its/lux-web/issues/599)).
- Added branch for testing ML v1.0.5 ([599](https://git.yale.edu/lux-its/lux-web/issues/599)).
- Added console.log for metadata and warnings for testing purposes ([599](https://git.yale.edu/lux-its/lux-web/issues/599)).
- Added facetsOnly parameter to faceted searches ([599](https://git.yale.edu/lux-its/lux-web/issues/599)).
- Added support for not displaying facets if empty array ([599](https://git.yale.edu/lux-its/lux-web/issues/599)).
- Added search tag error message ([608](https://git.yale.edu/lux-its/lux-web/issues/608)).
- Added What We Have section to person page ([437](https://git.yale.edu/lux-its/lux-web/issues/437)).
- Added works about section to person page ([445](https://git.yale.edu/lux-its/lux-web/issues/445)).
- Added "Objects Created/Encountered" for place page ([431](https://git.yale.edu/lux-its/lux-web/issues/431)).
- Added "Works created or encountered at", "Works about" and "Objects published at" for place page ([430](https://git.yale.edu/lux-its/lux-web/issues/430), [429](https://git.yale.edu/lux-its/lux-web/issues/429), [428](https://git.yale.edu/lux-its/lux-web/issues/428)).
- Added when timeline list to person page ([444](https://git.yale.edu/lux-its/lux-web/issues/444)).
- Added when timeline graph to person page ([444](https://git.yale.edu/lux-its/lux-web/issues/444)).
- Added works created by to group page ([446](https://git.yale.edu/lux-its/lux-web/issues/446)).
- Added works about by to group page ([445](https://git.yale.edu/lux-its/lux-web/issues/445)).
- Added objects created by to group page ([447](https://git.yale.edu/lux-its/lux-web/issues/447)).
- Added related agents to group page ([442](https://git.yale.edu/lux-its/lux-web/issues/442)).
- Added related subjects to group page ([441](https://git.yale.edu/lux-its/lux-web/issues/441)).
- Added related materials to group page ([439](https://git.yale.edu/lux-its/lux-web/issues/439)).
- Added what we have section to group page ([437](https://git.yale.edu/lux-its/lux-web/issues/437)).
- Added timeline section to group page ([444](https://git.yale.edu/lux-its/lux-web/issues/444)).
- Added objects related to section on concepts page ([417](https://git.yale.edu/lux-its/lux-web/issues/417)).
- Added works related to section on concepts page ([418](https://git.yale.edu/lux-its/lux-web/issues/418)).
- Added facets to peeopl/group results page ([638](https://git.yale.edu/lux-its/lux-web/issues/638)).
- Added explore section to place page ([427](https://git.yale.edu/lux-its/lux-web/issues/427)).
- Added facets to the place results page ([641](https://git.yale.edu/lux-its/lux-web/issues/641)).
- Added facets to the concept results page ([642](https://git.yale.edu/lux-its/lux-web/issues/642)).
- Added facets to the event results page ([643](https://git.yale.edu/lux-its/lux-web/issues/643)).
- Added ServiceNow link to footer ([574](https://git.yale.edu/lux-its/lux-web/issues/574)).
- Added What We Have section to the concepts page ([410](https://git.yale.edu/lux-its/lux-web/issues/410)).
- Added related agents to the place page ([426](https://git.yale.edu/lux-its/lux-web/issues/426)).
- Added related agents to the concept page ([414](https://git.yale.edu/lux-its/lux-web/issues/414)).
- Added timelines (when created/encountered) to the concept page ([415](https://git.yale.edu/lux-its/lux-web/issues/415)).
- Added infographic section to landing page ([565](https://git.yale.edu/lux-its/lux-web/issues/565)).
- Added parts property data to events page ([378](https://git.yale.edu/lux-its/lux-web/issues/378)).
- Added additional subject_to links ([507](https://git.yale.edu/lux-its/lux-web/issues/507)).
- Added Related Materials accordion to Place page ([613](https://git.yale.edu/lux-its/lux-web/issues/613)).
- Added explore hierarchy to concepts page ([416](https://git.yale.edu/lux-its/lux-web/issues/416)).
- Added hero image, featured collections, and footer blocks in landing page ([565](https://git.yale.edu/lux-its/lux-web/issues/565)).
- Added references to objects on the objects page ([386](https://git.yale.edu/lux-its/lux-web/issues/386)).
- Added Related Places accordion - to be changed to a map - to the Place page ([612](https://git.yale.edu/lux-its/lux-web/issues/612)).
- Added access point to digital objects entity page ([380](https://git.yale.edu/lux-its/lux-web/issues/380)).
- Added What We Have section to the place page ([422](https://git.yale.edu/lux-its/lux-web/issues/422)).
- Added related subjects to Place page ([425](https://git.yale.edu/lux-its/lux-web/issues/425)).
- Added list of types on results snippets ([570](https://git.yale.edu/lux-its/lux-web/issues/570)).
- Added browse by image container and view ([166](https://git.yale.edu/lux-its/lux-web/issues/166)).
- Added encountered_by data to the objects page ([700](https://git.yale.edu/lux-its/lux-web/issues/700)).
- Added addtional CMS contents ([697](https://git.yale.edu/lux-its/lux-web/issues/697)).
- Added advanced search page and base components ([705](https://git.yale.edu/lux-its/lux-web/issues/705)).
- Added advanced search input ([710](https://git.yale.edu/lux-its/lux-web/issues/710)).
- Added advanced search dropdown ([711](https://git.yale.edu/lux-its/lux-web/issues/711)).
- Added advanced search form container ([714](https://git.yale.edu/lux-its/lux-web/issues/714)).
- Added people born and died at place on place page ([724](https://git.yale.edu/lux-its/lux-web/issues/724)).
- Added people with gender, nationality, occupation, type to concept page ([726](https://git.yale.edu/lux-its/lux-web/issues/726)).
- Added expandable search bar to the header ([49](https://git.yale.edu/lux-its/lux-web/issues/49)).
- Added SiteImprove script ([746](https://git.yale.edu/lux-its/lux-web/issues/746)).
- Added member of section to groups page ([731](https://git.yale.edu/lux-its/lux-web/issues/731)).
- Added type to group and person page ([754](https://git.yale.edu/lux-its/lux-web/issues/754)).
- Added conceptInfluencedId to place, person, group, and concept pages ([756](https://git.yale.edu/lux-its/lux-web/issues/756)).
- Added carried by and shown by to works ([755](https://git.yale.edu/lux-its/lux-web/issues/755)).
- Added Help (FAQ) page ([744](https://git.yale.edu/lux-its/lux-web/issues/744)).
- Added updates to sbx ([762](https://git.yale.edu/lux-its/lux-web/issues/762)).
- Added all memeber_of data points ([768](https://git.yale.edu/lux-its/lux-web/issues/768)).
- Added updates to sbx ([762](https://git.yale.edu/lux-its/lux-web/issues/762)).
- Added ML v1.0.5 changes to frontend ([727](https://git.yale.edu/lux-its/lux-web/issues/727)).
- Added locations to concept pages ([615](https://git.yale.edu/lux-its/lux-web/issues/615)).
- Added estimates back into the results ([777](https://git.yale.edu/lux-its/lux-web/issues/777)).
- Added supertype icons ([764](https://git.yale.edu/lux-its/lux-web/issues/764)).
- Added unit data to objects and works pages ([793](https://git.yale.edu/lux-its/lux-web/issues/793)).
- Added digitally_carries and digitally_shows ([803](https://git.yale.edu/lux-its/lux-web/issues/803)).
- Added workDepictsAgentId to person page and workDepictsPlaceId to place page ([807](https://git.yale.edu/lux-its/lux-web/issues/807)).
- Added actions link based on unit data ([794](https://git.yale.edu/lux-its/lux-web/issues/794)).
- Added search links to related lists ([815](https://git.yale.edu/lux-its/lux-web/issues/815)).
- Added parentheses around the search criteria ([824](https://git.yale.edu/lux-its/lux-web/issues/824)).
- Added error handling for search results ([801](https://git.yale.edu/lux-its/lux-web/issues/801)).
- Added feedback form to the actions menu ([829](https://git.yale.edu/lux-its/lux-web/issues/829)).
- Added parentheses around the search criteria in facet requests ([824](https://git.yale.edu/lux-its/lux-web/issues/824)).
- Added explore hierarchy to sets page ([241](https://git.yale.edu/lux-its/lux-web/issues/241)).
- Added materials to objects pages ([846](https://git.yale.edu/lux-its/lux-web/issues/846)).
- Added collection pages faceted sections ([842](https://git.yale.edu/lux-its/lux-web/issues/842)).
- Added search query to results page ([767](https://git.yale.edu/lux-its/lux-web/issues/767)).

### Changed

- Changed routes for pages ([PR-3](https://git.yale.edu/lux-its/lux-web/pull/3)).
- Changed folder structure for tests ([PR-4](https://git.yale.edu/lux-its/lux-web/pull/4)).
- Changed incorrect properties in entity interfaces ([PR-23](https://git.yale.edu/lux-its/lux-web/pull/23)).
- Changed item header component ([53](https://git.yale.edu/lux-its/lux-web/issues/53)).
- Changed common functionality for shared widgets ([86](https://git.yale.edu/lux-its/lux-web/issues/86)).
- Changed TextValue to accept list style prop ([119](https://git.yale.edu/lux-its/lux-web/issues/119)).
- Changed RelationshipContainer to make API query calls ([123](https://git.yale.edu/lux-its/lux-web/issues/123)).
- Changed RecordLink to accommodate data structure changes ([129](https://git.yale.edu/lux-its/lux-web/issues/129)).
- Changed ItemHeader for person page ([148](https://git.yale.edu/lux-its/lux-web/issues/148)).
- Changed integration testing ([159](https://git.yale.edu/lux-its/lux-web/issues/159)).
- Changed search results interface ([175](https://git.yale.edu/lux-its/lux-web/issues/175)).
- Changed routing ([261](https://git.yale.edu/lux-its/lux-web/issues/261)).
- Changed getReferredToBy function ([265](https://git.yale.edu/lux-its/lux-web/issues/265)).
- Changed object result snippet ([263](https://git.yale.edu/lux-its/lux-web/issues/263)).
- Changed getReferredToBy function ([265](https://git.yale.edu/lux-its/lux-web/issues/265)).
- Changed results snippets ([270](https://git.yale.edu/lux-its/lux-web/issues/270)).
- Changed extraction functions to return empty array or null ([278](https://git.yale.edu/lux-its/lux-web/issues/278)).
- Changed linguistic object event section ([284](https://git.yale.edu/lux-its/lux-web/issues/284)).
- Changed getAgents to get all agents ([309](https://git.yale.edu/lux-its/lux-web/issues/309)).
- Changed names and title rendering ([312](https://git.yale.edu/lux-its/lux-web/issues/312)).
- Changed export json to view json ([351](https://git.yale.edu/lux-its/lux-web/issues/351)).
- Changed search params to include parentheses ([449](https://git.yale.edu/lux-its/lux-web/issues/449)).
- Changed production event to include attributed_by ([345](https://git.yale.edu/lux-its/lux-web/issues/345)).
- Changed dimensions rendering based on dimensions statement ([472](https://git.yale.edu/lux-its/lux-web/issues/472)).
- Changed the way biography data is rendered ([470](https://git.yale.edu/lux-its/lux-web/issues/470)).
- Changed notes rendering ([466](https://git.yale.edu/lux-its/lux-web/issues/466)).
- Changed the label for the original work agent ([494](https://git.yale.edu/lux-its/lux-web/issues/494)).
- Changed access statement location on page ([496](https://git.yale.edu/lux-its/lux-web/issues/496)).
- Changed search query to accommodate ML v1.0.2 ([521](https://git.yale.edu/lux-its/lux-web/issues/521)).
- Changed the way contributing records are rendered ([504](https://git.yale.edu/lux-its/lux-web/issues/504)).
- Changed the base URL env name ([651](https://git.yale.edu/lux-its/lux-web/issues/651)).
- Changed referrerPolicy for the ServiceNow link to send path and query part of URL too ([574](https://git.yale.edu/lux-its/lux-web/issues/574)).
- Changed the url string when user selects facets on results page ([662](https://git.yale.edu/lux-its/lux-web/issues/662)).
- Changed labels for notes ([528](https://git.yale.edu/lux-its/lux-web/issues/528)).
- Changed layout for "About LUX" contents ([697](https://git.yale.edu/lux-its/lux-web/issues/697)).
- Changed searchbox to allow setting an ID ([739](https://git.yale.edu/lux-its/lux-web/issues/739)).
- Changed the person snippet header ([735](https://git.yale.edu/lux-its/lux-web/issues/735)).
- Changed the rendering of related objects/works agents ([734](https://git.yale.edu/lux-its/lux-web/issues/734)).
- Changed the production event labels and missing data ([492](https://git.yale.edu/lux-its/lux-web/issues/492)).
- Changed data labels and values to descriptions lists, terms, and details ([691](https://git.yale.edu/lux-its/lux-web/issues/691)).
- Changed how facets are called on the results page ([670](https://git.yale.edu/lux-its/lux-web/issues/670)).
- Made the left contents panel be closed on load ([749](https://git.yale.edu/lux-its/lux-web/issues/749)).
- Search tips link now points to a distict CMS page ([744](https://git.yale.edu/lux-its/lux-web/issues/744)).
- Changed results page to only send search request once ([790](https://git.yale.edu/lux-its/lux-web/issues/790)).
- Frontend now sends facet search requests using a different domain name ([789](https://git.yale.edu/lux-its/lux-web/issues/789)).
- Using a relative path for LUX record link for the hero image ([795](https://git.yale.edu/lux-its/lux-web/issues/795)).
- Changed 'Can I re-use it?' section to link to rights info page ([388](https://git.yale.edu/lux-its/lux-web/issues/388)).
- Changed contact link with new production environment link ([796](https://git.yale.edu/lux-its/lux-web/issues/796)).
- Changed the tab headers ([818](https://git.yale.edu/lux-its/lux-web/issues/818)).
- Changed entity header to shorten long names ([808](https://git.yale.edu/lux-its/lux-web/issues/808)).
- Changed 'Limited Functionality' warning to say 'Beta' instead of 'Alpha' ([827](https://git.yale.edu/lux-its/lux-web/issues/827)).
- Changed 'Can I re-use it?' section to conditionally display default message, and the wording for the rights info link ([833](https://git.yale.edu/lux-its/lux-web/issues/833)).
- Changed ExploreHierarchy to use an array of child queries ([241](https://git.yale.edu/lux-its/lux-web/issues/241)).
- Changed the people and orgs icon on entity pages ([859](https://git.yale.edu/lux-its/lux-web/issues/859)).
- Divided FAQ (help) page into three: General, Search Tips, and Rights ([820](https://git.yale.edu/lux-its/lux-web/issues/820)).
- Robots.txt is now created by server depending on the environment ([863](https://git.yale.edu/lux-its/lux-web/issues/863)).
- Increased page limit to 100 for content retrieval through CMS API ([811](https://git.yale.edu/lux-its/lux-web/issues/811)).

### Removed

- Removed Counter feature and additional files ([PR-2](https://git.yale.edu/lux-its/lux-web/pull/2))
- Removed getIds function ([288](https://git.yale.edu/lux-its/lux-web/issues/288)).
- Removed NoDataFound ([307](https://git.yale.edu/lux-its/lux-web/issues/307)).
- Removed item type from types list ([465](https://git.yale.edu/lux-its/lux-web/issues/465)).
- Removed item type from types list ([473](https://git.yale.edu/lux-its/lux-web/issues/473)).
- Removed unit on site link at bottom of object pages ([498](https://git.yale.edu/lux-its/lux-web/issues/498)).
- Removed item from rendering in item list ([620](https://git.yale.edu/lux-its/lux-web/issues/620)).
- Removed estimates from tabs temporarily ([777](https://git.yale.edu/lux-its/lux-web/issues/777)).
- Removed Show All 0 Results links ([809](https://git.yale.edu/lux-its/lux-web/issues/809)).
- Removed link to record on unit site from bottom of page on works ([807](https://git.yale.edu/lux-its/lux-web/issues/807)).
- Removed related lists that are duplicates ([727](https://git.yale.edu/lux-its/lux-web/issues/727)).
- Removed items from related concepts lists ([830](https://git.yale.edu/lux-its/lux-web/issues/830)).
- Removed link to record on unit site from bottom of all pages ([844](https://git.yale.edu/lux-its/lux-web/issues/844)).
- Removed unwanted related dropdowns on place page ([843](https://git.yale.edu/lux-its/lux-web/issues/843)).

### Fixed

- Fixed redirecting from landing page to results page ([44](https://git.yale.edu/lux-its/lux-web/issues/44)).
- Fixed eslint issues in types folder ([46](https://git.yale.edu/lux-its/lux-web/issues/46)).
- Fixed blank data sections in physical objects page ([234](https://git.yale.edu/lux-its/lux-web/issues/234)).
- Fixed errors on person page ([256](https://git.yale.edu/lux-its/lux-web/issues/256)).
- Fixed linting errors ([258](https://git.yale.edu/lux-its/lux-web/issues/258)).
- Fixed results snippets filtering ([304](https://git.yale.edu/lux-its/lux-web/issues/304)).
- Fixed undefined urls passed to RecordLink ([310](https://git.yale.edu/lux-its/lux-web/issues/310)).
- Fixed broken links or flagged them as WIP ([327](https://git.yale.edu/lux-its/lux-web/issues/327)).
- Fixed actions menu on object pages ([328](https://git.yale.edu/lux-its/lux-web/issues/328)).
- Fixed person results ([329](https://git.yale.edu/lux-its/lux-web/issues/329)).
- Fixed person page missing data ([338](https://git.yale.edu/lux-its/lux-web/issues/338)).
- Fixed group page data extraction issues ([340](https://git.yale.edu/lux-its/lux-web/issues/340)).
- Fixed person and group page dates rendering ([357](https://git.yale.edu/lux-its/lux-web/issues/357)).
- Fixed works results snippets ([356](https://git.yale.edu/lux-its/lux-web/issues/356)).
- Fixed member_of function ([476](https://git.yale.edu/lux-its/lux-web/issues/476)).
- Fixed various dates issues ([475](https://git.yale.edu/lux-its/lux-web/issues/475)).
- Fixed original work link ([471](https://git.yale.edu/lux-its/lux-web/issues/471)).
- Fixed breaking tests and updated mocks ([489](https://git.yale.edu/lux-its/lux-web/issues/489)).
- Fixed formation data extraction and rendering ([497](https://git.yale.edu/lux-its/lux-web/issues/497)).
- Fixed missing event properties ([495](https://git.yale.edu/lux-its/lux-web/issues/495)).
- Fixed back functionality when returning to results page ([462](https://git.yale.edu/lux-its/lux-web/issues/462)).
- Fixed swapped results tabs for concepts and events ([533](https://git.yale.edu/lux-its/lux-web/issues/533)).
- Fixed the search tag for related objects on person page ([536](https://git.yale.edu/lux-its/lux-web/issues/536)).
- Fixed objects page layout ([546](https://git.yale.edu/lux-its/lux-web/issues/546)).
- Fixed "See all ..." link not resolving to valid results ([543](https://git.yale.edu/lux-its/lux-web/issues/543)).
- Fixed styling for results tabs ([548](https://git.yale.edu/lux-its/lux-web/issues/548)).
- Fixed misalignment of labels and values in works result snippets ([545](https://git.yale.edu/lux-its/lux-web/issues/545)).
- Fixed misalignment of thumbnails in person/created or discovered by ([559](https://git.yale.edu/lux-its/lux-web/issues/559)).
- Restored links in result lists ([544](https://git.yale.edu/lux-its/lux-web/issues/544))
- Fixed pagination and facet error ([577](https://git.yale.edu/lux-its/lux-web/issues/577)).
- Fixed bugs on related sections on person page ([442](https://git.yale.edu/lux-its/lux-web/issues/442)).
- Fixed place of birth and death ([590](https://git.yale.edu/lux-its/lux-web/issues/590)).
- Fixed checkbox selection by clicking text ([567](https://git.yale.edu/lux-its/lux-web/issues/567)).
- Fixed invalid link to record site appearing when it does not exist ([584](https://git.yale.edu/lux-its/lux-web/issues/584)).
- Fixed empty search string causing error by ignoring it on submission ([585](https://git.yale.edu/lux-its/lux-web/issues/585)).
- Fixed empty search string causing error by ignoring it when read on the results page ([585](https://git.yale.edu/lux-its/lux-web/issues/585)).
- Fixed person page integration tests ([445](https://git.yale.edu/lux-its/lux-web/issues/445)).
- Fixed rendering of agent role in case of empty role ([619](https://git.yale.edu/lux-its/lux-web/issues/619)).
- Fixed formation and dissolution functions on group pages ([624](https://git.yale.edu/lux-its/lux-web/issues/624)).
- Fixed concept snippet description preview ([588](https://git.yale.edu/lux-its/lux-web/issues/588)).
- Fixed the group page search tags config ([635](https://git.yale.edu/lux-its/lux-web/issues/635)).
- Fixed related agents to not show current agent ([442](https://git.yale.edu/lux-its/lux-web/issues/442)).
- Fixed date facets for the event results page ([643](https://git.yale.edu/lux-its/lux-web/issues/643)).
- Fixed person and group page timeline query requests ([653](https://git.yale.edu/lux-its/lux-web/issues/653)).
- Fixed action menu on concept page ([506](https://git.yale.edu/lux-its/lux-web/issues/506)).
- Fixed the snippet titles so they cut off ([594](https://git.yale.edu/lux-its/lux-web/issues/594)).
- Fixed the Places tab labels ([669](https://git.yale.edu/lux-its/lux-web/issues/669)).
- Fixed results totals from changing on facet selection ([663](https://git.yale.edu/lux-its/lux-web/issues/663)).
- Fixed selected filters functionality for checklists ([662](https://git.yale.edu/lux-its/lux-web/issues/662)).
- Fixed facet functionality for dates ([662](https://git.yale.edu/lux-its/lux-web/issues/662)).
- Fixed facet date sorting function ([685](https://git.yale.edu/lux-its/lux-web/issues/685)).
- Fixed syntax error in related sections requests on entity pages ([687](https://git.yale.edu/lux-its/lux-web/issues/687)).
- Fixed random selection of featured collections in landing page ([692](https://git.yale.edu/lux-its/lux-web/issues/692)).
- Fixed toggle graph/list button on entity pages ([664](https://git.yale.edu/lux-its/lux-web/issues/664)).
- Fixed content and info panels not appearing in universal viewer ([676](https://git.yale.edu/lux-its/lux-web/issues/676)).
- Fixed checkbox should be checked facet is selected ([601](https://git.yale.edu/lux-its/lux-web/issues/601)).
- Fixed ServiceNow link to send ref_url ([716](https://git.yale.edu/lux-its/lux-web/issues/716)).
- Fixed facets to be sent as AND in search request ([703](https://git.yale.edu/lux-its/lux-web/issues/703)).
- Fixed current url captured for ServiceNow link ([716](https://git.yale.edu/lux-its/lux-web/issues/716)).
- Fixed dropdown options for advanced search ([711](https://git.yale.edu/lux-its/lux-web/issues/711)).
- Fixed backwards incompatibilities for ML v1.0.5 ([732](https://git.yale.edu/lux-its/lux-web/issues/732)).
- Fixed failing integration tests ([736](https://git.yale.edu/lux-its/lux-web/issues/736)).
- Fixed encountered_by agent labels ([700](https://git.yale.edu/lux-its/lux-web/issues/700)).
- Fixed data constants ([761](https://git.yale.edu/lux-its/lux-web/issues/761)).
- Fix encountered_by agent labels ([700](https://git.yale.edu/lux-its/lux-web/issues/700)).
- Fixed facet date range to accommodate negative dates ([583](https://git.yale.edu/lux-its/lux-web/issues/583)).
- Fixed results page facets requests ([775](https://git.yale.edu/lux-its/lux-web/issues/775)).
- Fixed zoom controls not showing in IIIF viewer ([742](https://git.yale.edu/lux-its/lux-web/issues/742)).
- Fixed Works' "Can I re-use it?" secition to display correct "Subject To" when available ([372](https://git.yale.edu/lux-its/lux-web/issues/372)).
- Fixed some hero images not being retreived ([811](https://git.yale.edu/lux-its/lux-web/issues/811)).
- Fixed UV thumbnail size problem by upgrading UV ([848](https://git.yale.edu/lux-its/lux-web/issues/848)).
- Fixed search bar not being editable and error display on results page ([857](https://git.yale.edu/lux-its/lux-web/issues/857)).
